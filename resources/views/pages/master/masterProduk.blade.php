        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-end">
                    <form action="/master-produk" method="get">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" name="deskripsi_produk" placeholder="Deskripsi Produk">
                        <input type="text" class="form-control mb-3" name="harga_produk" placeholder="10000">
                    </div>
                </div>
